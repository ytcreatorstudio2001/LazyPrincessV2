        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Main Channel ↭  🔥', url='https://telegram.me/MovieHub_2k22') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ DEV Channel ↭  🔥', url='https://t.me/moviehub_plus') ]
                                                                                    ] )
                )
